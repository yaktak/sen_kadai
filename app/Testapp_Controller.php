...
require_once 'Testapp_Error.php';
require_once 'Testapp_ActionClass.php';
 ...
 *  @package    Testapp
 */
class Testapp_Controller extends Ethna_Controller
{
    /**#@+
     *  @access protected
     */
    ...
    public $class = array(
        ...
        'form'          => 'Testapp_ActionForm',
        'i18n'          => 'Ethna_I18N',
        'logger'        => 'Ethna_Logger',
        'plugin'        => 'Ethna_Plugin',
        'session'       => 'Ethna_Session',
        'view'          => 'Testapp_ViewClass',
        'renderer'      => 'Ethna_Renderer_Smarty',
        'url_handler'   => 'Testapp_UrlHandler',
    );
